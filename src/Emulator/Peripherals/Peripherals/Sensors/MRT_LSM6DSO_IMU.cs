...
namespace Antmicro.Renode.Peripherals.Sensors
{
    public class MRT_LSM6DSO_IMU : BasicBytePeripheral, II2CPeripheral, IProvidesRegisterCollection<ByteRegisterCollection>, ITemperatureSensor
    {
        public MRT_LSM6DSO_IMU(IMachine machine) : base(machine)
        {
            ...
            commonFifo = new MRT_LSM6DSO_FIFO(machine, this, "fifo", MaxFifoWords);
        ...
        private void DefineRegistersInternal()
        {
            ...
            Registers.WhoAmI.Define(this)
                .WithValueField(0, 8, FieldMode.Read, name: "WHO_AM_I", valueProviderCallback: _ => 0x6B)
                ;
        ...
        private readonly MRT_LSM6DSO_FIFO commonFifo;
        ...
        private class MRT_LSM6DSO_FIFO
        {
            public MRT_LSM6DSO_FIFO(IMachine machine, MRT_LSM6DSO_IMU owner, string name, uint capacity)
            {
                Capacity = capacity;
            ...
            private readonly MRT_LSM6DSO_IMU owner;
        }
